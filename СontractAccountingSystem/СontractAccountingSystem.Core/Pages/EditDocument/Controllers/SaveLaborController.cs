...
{
    public class SaveLaborController : Controller<EditLaborDocumentPage>
    {
        ...
        {
            Element.Model.DocumentType = "Договор на фактические услуги";
            return new ArchiveDocumentModel
            {
                ...
                WorkerName = Element.WorkerName.Value,
                ...
                OrganizationName = new OrganizationModel(),
